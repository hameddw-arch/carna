...
export default function HomePage() {
  ...
  return (
    <>
      ...
      <section className="py-xl px-margin-desktop bg-surface-white dark:bg-background">
        <div className="max-w-container-max mx-auto">
          <div className="flex justify-between items-end mb-lg">
            <div>
              <div className="font-label-lg text-label-lg text-primary dark:text-yellow-400 mb-1">ابحث بالماركة</div>
              <h2 className="font-headline-md text-headline-md text-text-primary dark:text-on-surface">كل الماركات، مكان واحد</h2>
            </div>
            <button
              onClick={() => { setHeroBrand('اختر الماركة'); document.getElementById('all-cars-section')?.scrollIntoView({ behavior: 'smooth' }); }}
              className="flex items-center gap-1 font-label-lg text-label-lg text-text-muted dark:text-on-surface-variant hover:text-primary dark:hover:text-yellow-400 transition-colors">
      ...
      <section className="py-xl px-margin-desktop bg-surface-white dark:bg-background border-b border-border-light dark:border-border-light">
        <div className="max-w-container-max mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-md">
            {/* Sedan */}
            <div onClick={() => { setBodyTypeFilter('سيدان'); document.getElementById('all-cars-section')?.scrollIntoView({ behavior: 'smooth' }); }} className="bg-surface-white dark:bg-surface border border-border-light dark:border-border-light rounded-xl p-md flex flex-col items-center justify-center gap-sm cursor-pointer hover:border-accent-yellow dark:hover:border-yellow-400 transition-all group">
              ...
              <span className="font-label-lg text-label-lg text-text-primary dark:text-on-surface">سيدان</span>
            </div>
            {/* SUV */}
            <div onClick={() => { setBodyTypeFilter('دفع رباعي (SUV)'); document.getElementById('all-cars-section')?.scrollIntoView({ behavior: 'smooth' }); }} className="bg-surface-white dark:bg-surface border border-border-light dark:border-border-light rounded-xl p-md flex flex-col items-center justify-center gap-sm cursor-pointer hover:border-accent-yellow dark:hover:border-yellow-400 transition-all group">
              ...
              <span className="font-label-lg text-label-lg text-text-primary dark:text-on-surface">دفع رباعي (SUV)</span>
            </div>
            {/* Pickup */}
            <div onClick={() => { setBodyTypeFilter('بيك أب'); document.getElementById('all-cars-section')?.scrollIntoView({ behavior: 'smooth' }); }} className="bg-surface-white dark:bg-surface border border-border-light dark:border-border-light rounded-xl p-md flex flex-col items-center justify-center gap-sm cursor-pointer hover:border-accent-yellow dark:hover:border-yellow-400 transition-all group">
              ...
              <span className="font-label-lg text-label-lg text-text-primary dark:text-on-surface">بيكاب</span>
            </div>
            {/* Van */}
            <div onClick={() => { setBodyTypeFilter('فان'); document.getElementById('all-cars-section')?.scrollIntoView({ behavior: 'smooth' }); }} className="bg-surface-white dark:bg-surface border border-border-light dark:border-border-light rounded-xl p-md flex flex-col items-center justify-center gap-sm cursor-pointer hover:border-accent-yellow dark:hover:border-yellow-400 transition-all group">
              ...
              <span className="font-label-lg text-label-lg text-text-primary dark:text-on-surface">فان</span>
            </div>
            {/* Hatchback */}
            <div onClick={() => { setBodyTypeFilter('هاتشباك'); document.getElementById('all-cars-section')?.scrollIntoView({ behavior: 'smooth' }); }} className="bg-surface-white dark:bg-surface border border-border-light dark:border-border-light rounded-xl p-md flex flex-col items-center justify-center gap-sm cursor-pointer hover:border-accent-yellow dark:hover:border-yellow-400 transition-all group">
              ...
              <span className="font-label-lg text-label-lg text-text-primary dark:text-on-surface">هاتشباك</span>
            </div>
            {/* Coupe */}
            <div onClick={() => { setBodyTypeFilter('كوبيه'); document.getElementById('all-cars-section')?.scrollIntoView({ behavior: 'smooth' }); }} className="bg-surface-white dark:bg-surface border border-border-light dark:border-border-light rounded-xl p-md flex flex-col items-center justify-center gap-sm cursor-pointer hover:border-accent-yellow dark:hover:border-yellow-400 transition-all group">
              ...
              <span className="font-label-lg text-label-lg text-text-primary dark:text-on-surface">كوبيه</span>
            </div>
          </div>
        </div>
      </section>

      <section id="all-cars-section" className="py-xl px-margin-desktop bg-surface-container-low dark:bg-background">
        <div className="max-w-container-max mx-auto">
          <div className="flex justify-between items-center mb-lg">
            ...
            <div className="flex items-center gap-xs font-label-lg text-label-lg text-text-muted dark:text-on-surface-variant">
              ...
              <select value={sortOrder} onChange={e => setSortOrder(e.target.value)} className="bg-transparent dark:bg-surface border-none dark:border-border-light dark:text-yellow-400 focus:ring-0 font-bold text-primary dark:text-yellow-400">
          ...
          <div className="flex flex-col md:flex-row-reverse gap-lg">
                ...
                <div className="space-y-md">
                  <div className="flex flex-col gap-xs">
                    ...
                    <div className="flex gap-xs">
                      <button onClick={() => setConditionFilter('الكل')} className={`flex-1 py-2 rounded-lg font-label-lg transition-colors ${conditionFilter === 'الكل' ? 'border border-primary dark:border-yellow-400 bg-primary-container/10 dark:bg-yellow-400/20 text-primary dark:text-yellow-400' : 'border border-border-light dark:border-border-light text-text-muted dark:text-on-surface-variant hover:border-primary dark:hover:border-yellow-400'}`}>الكل</button>
                      <button onClick={() => setConditionFilter('جديد')} className={`flex-1 py-2 rounded-lg font-label-lg transition-colors ${conditionFilter === 'جديد' ? 'border border-primary dark:border-yellow-400 bg-primary-container/10 dark:bg-yellow-400/20 text-primary dark:text-yellow-400' : 'border border-border-light dark:border-border-light text-text-muted dark:text-on-surface-variant hover:border-primary dark:hover:border-yellow-400'}`}>جديد</button>
                      <button onClick={() => setConditionFilter('مستعمل')} className={`flex-1 py-2 rounded-lg font-label-lg transition-colors ${conditionFilter === 'مستعمل' ? 'border border-primary dark:border-yellow-400 bg-primary-container/10 dark:bg-yellow-400/20 text-primary dark:text-yellow-400' : 'border border-border-light dark:border-border-light text-text-muted dark:text-on-surface-variant hover:border-primary dark:hover:border-yellow-400'}`}>مستعمل</button>
                    </div>
                  </div>
                  <div className="flex flex-col gap-xs text-right">
                    <label className="font-label-sm text-label-sm text-text-muted dark:text-on-surface-variant">المحافظة</label>
                    <select value={locationFilter} onChange={e => setLocationFilter(e.target.value)} className="border-border-light dark:border-border-light dark:bg-surface-white dark:text-on-surface rounded-lg font-body-md text-body-md w-full focus:ring-accent-yellow dark:focus:ring-yellow-400">
                  ...
                  <div className="flex flex-col gap-xs text-right">
                    ...
                    <select value={bodyTypeFilter} onChange={e => setBodyTypeFilter(e.target.value)} className="border-border-light dark:border-border-light dark:bg-surface-white dark:text-on-surface rounded-lg font-body-md text-body-md w-full focus:ring-accent-yellow dark:focus:ring-yellow-400">
                  ...
                  <div className="flex flex-col gap-xs text-right">
                    ...
                    <select value={yearFilter} onChange={e => setYearFilter(e.target.value)} className="border-border-light dark:border-border-light dark:bg-surface-white dark:text-on-surface rounded-lg font-body-md text-body-md w-full focus:ring-accent-yellow dark:focus:ring-yellow-400">
                      <option>الكل</option>
                      <option>2024</option>
                      <option>2023</option>
                      <option>2022</option>
                  ...
                  <div className="flex flex-col gap-xs text-right">
                    ...
                    <div className="flex gap-xs">
                      <input value={minPrice} onChange={e => setMinPrice(e.target.value)} className="w-1/2 border-border-light dark:border-border-light dark:bg-surface-white dark:text-on-surface rounded-lg font-body-md text-body-md focus:ring-accent-yellow dark:focus:ring-yellow-400" placeholder="من" type="number" />
                      <input value={maxPrice} onChange={e => setMaxPrice(e.target.value)} className="w-1/2 border-border-light dark:border-border-light dark:bg-surface-white dark:text-on-surface rounded-lg font-body-md text-body-md focus:ring-accent-yellow dark:focus:ring-yellow-400" placeholder="إلى" type="number" />
                    </div>
                  </div>
                  <div className="flex flex-col gap-xs text-right">
                    <label className="font-label-sm text-label-sm text-text-muted dark:text-on-surface-variant">نوع الوقود</label>
                    <select value={fuelTypeFilter} onChange={e => setFuelTypeFilter(e.target.value)} className="border-border-light dark:border-border-light dark:bg-surface-white dark:text-on-surface rounded-lg font-body-md text-body-md w-full focus:ring-accent-yellow dark:focus:ring-yellow-400">
                      <option>الكل</option>
                      <option>بنزين</option>
                      <option>ديزل</option>
                  ...
                  <div className="flex flex-col gap-xs text-right">
                    <label className="font-label-sm text-label-sm text-text-muted dark:text-on-surface-variant">ناقل الحركة</label>
                    <select value={transmissionFilter} onChange={e => setTransmissionFilter(e.target.value)} className="border-border-light dark:border-border-light dark:bg-surface-white dark:text-on-surface rounded-lg font-body-md text-body-md w-full focus:ring-accent-yellow dark:focus:ring-yellow-400">
                      <option>الكل</option>
                      <option>أوتوماتيك</option>
                      <option>يدوي (عادي)</option>
                    </select>
                  </div>
                  <button onClick={() => { applyFilters(); document.getElementById('all-cars-section')?.scrollIntoView({ behavior: 'smooth' }); }} className="w-full bg-primary dark:bg-yellow-500 text-on-primary dark:text-black py-sm rounded-lg font-label-lg mt-md hover:brightness-110 dark:hover:brightness-90 transition-all">تطبيق الفلاتر</button>
                </div>
              </div>
            </aside>
            {/* Main Grid (Left) */}
            <main className="w-full md:w-3/4">
              {filteredCars.length > 0 ? (
                ...
                <div className="flex flex-col items-center justify-center bg-surface-white dark:bg-surface border border-border-light dark:border-border-light rounded-lg py-xl px-md h-full">
                  <span className="material-symbols-outlined text-[64px] text-text-muted dark:text-on-surface-variant opacity-50 mb-sm">search_off</span>
                  <h3 className="font-headline-md text-headline-md text-text-primary dark:text-on-surface mb-xs">لا توجد سيارات مطابقة</h3>
                  <p className="font-body-md text-body-md text-text-muted dark:text-on-surface-variant text-center max-w-[384px] mb-md">
                  ...
                  <button 
                    ...
                    className="bg-primary-container dark:bg-yellow-500 text-on-primary-container dark:text-black px-lg py-xs rounded-lg font-label-lg hover:bg-inverse-primary dark:hover:brightness-90 transition-all">
                    مسح جميع الفلاتر
                  </button>
                </div>
              )}
              <div className="mt-xl flex justify-center">
                <Link to="/browse" className="px-xl py-sm border border-primary dark:border-yellow-400 text-primary dark:text-yellow-400 rounded-lg font-label-lg hover:bg-primary-container/10 dark:hover:bg-yellow-400/10 transition-all">مشاهدة المزيد من السيارات</Link>
              </div>
            </main>
          </div>
        </div>
      ...
      <section className="py-xl px-margin-desktop bg-surface-white dark:bg-background">
        <div className="max-w-container-max mx-auto">
          <div className="flex justify-between items-center mb-lg">
            <h2 className="font-headline-md text-headline-md text-text-primary dark:text-on-surface">سيارات... على السريع</h2>
            <Link className="text-secondary dark:text-blue-400 font-label-lg text-label-lg hover:underline" to="/browse">عرض الكل</Link>
          </div>
      ...
      <section className="bg-surface-container dark:bg-background py-md">
        <div className="max-w-container-max mx-auto px-margin-desktop">
          <div className="bg-secondary-container/10 dark:bg-blue-900/30 border border-secondary-container/30 dark:border-blue-800/50 rounded-lg p-sm flex items-center justify-between text-secondary dark:text-blue-400">
            ...
            <button className="bg-secondary dark:bg-blue-600 text-on-secondary dark:text-white px-sm py-1 rounded-lg font-label-lg text-label-lg hover:bg-secondary/90 dark:hover:bg-blue-700 transition-all">اعرف المزيد</button>
          </div>
        </div>
      </section>
      ...
      <section className="py-xl px-margin-desktop bg-surface-container-low dark:bg-background">
        <div className="max-w-container-max mx-auto">
          <div className="flex justify-between items-center mb-lg">
            <h2 className="font-headline-md text-headline-md text-text-primary dark:text-on-surface">أبرز ورشات الصيانة</h2>
            <Link className="text-secondary dark:text-blue-400 font-label-lg text-label-lg hover:underline" to="/workshops">استكشف الورشات</Link>
          </div>
          <div className="flex gap-md overflow-x-auto pb-sm no-scrollbar">
            <div className="min-w-[300px] bg-surface-white dark:bg-surface border border-border-light dark:border-border-light rounded-lg p-sm flex items-center gap-sm hover:border-verification-blue dark:hover:border-blue-400 transition-all">
              <div className="w-16 h-16 rounded-lg bg-surface-container dark:bg-surface-white flex items-center justify-center overflow-hidden flex-shrink-0">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-1">
                  <h4 className="font-headline-sm text-headline-sm text-text-primary dark:text-on-surface">مركز التميز</h4>
                  <span className="material-symbols-outlined text-verification-blue dark:text-blue-400 text-[18px]" style={{ fontVariationSettings: "'FILL' 1" }}>verified</span>
                </div>
                <p className="font-body-sm text-body-sm text-text-muted dark:text-on-surface-variant mb-xs">صيانة المحركات والبرمجة</p>
                <div className="flex items-center justify-between">
                  <div className="flex items-center text-accent-yellow">
                    <span className="material-symbols-outlined text-[14px]" style={{ fontVariationSettings: "'FILL' 1" }}>star</span>
                    <span className="font-label-sm text-label-sm text-text-primary dark:text-on-surface mr-1">4.8</span>
                  </div>
                  <button className="text-secondary dark:text-blue-400 font-label-sm text-label-sm border border-secondary dark:border-blue-400 rounded px-2 py-0.5 hover:bg-secondary dark:hover:bg-blue-900 hover:text-white transition-all">عرض الخدمات</button>
                </div>
              </div>
            </div>
            {/* Workshop 2 */}
            <div className="min-w-[300px] bg-surface-white dark:bg-surface border border-border-light dark:border-border-light rounded-lg p-sm flex items-center gap-sm hover:border-verification-blue dark:hover:border-blue-400 transition-all">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-1">
                  <h4 className="font-headline-sm text-headline-sm text-text-primary dark:text-on-surface">ورشة المحترف</h4>
                  <span className="material-symbols-outlined text-verification-blue dark:text-blue-400 text-[18px]" style={{ fontVariationSettings: "'FILL' 1" }}>verified</span>
                </div>
                <p className="font-body-sm text-body-sm text-text-muted dark:text-on-surface-variant mb-xs">كهرباء وتكييف سيارات</p>
                <div className="flex items-center justify-between">
                  <div className="flex items-center text-accent-yellow">
                    <span className="material-symbols-outlined text-[14px]" style={{ fontVariationSettings: "'FILL' 1" }}>star</span>
                    <span className="font-label-sm text-label-sm text-text-primary dark:text-on-surface mr-1">4.9</span>
                  </div>
                  <button className="text-secondary dark:text-blue-400 font-label-sm text-label-sm border border-secondary dark:border-blue-400 rounded px-2 py-0.5 hover:bg-secondary dark:hover:bg-blue-900 hover:text-white transition-all">عرض الخدمات</button>
                </div>
              </div>
            ...
            <div className="min-w-[300px] bg-surface-white dark:bg-surface border border-border-light dark:border-border-light rounded-lg p-sm flex items-center gap-sm hover:border-verification-blue dark:hover:border-blue-400 transition-all">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-1">
                  <h4 className="font-headline-sm text-headline-sm text-text-primary dark:text-on-surface">الأمانة للأصباغ</h4>
                  <span className="material-symbols-outlined text-verification-blue dark:text-blue-400 text-[18px]" style={{ fontVariationSettings: "'FILL' 1" }}>verified</span>
                </div>
                <p className="font-body-sm text-body-sm text-text-muted dark:text-on-surface-variant mb-xs">حدادة وصبغ حراري</p>
                <div className="flex items-center justify-between">
                  <div className="flex items-center text-accent-yellow">
                    <span className="material-symbols-outlined text-[14px]" style={{ fontVariationSettings: "'FILL' 1" }}>star</span>
                    <span className="font-label-sm text-label-sm text-text-primary dark:text-on-surface mr-1">4.5</span>
                  </div>
                  <button className="text-secondary dark:text-blue-400 font-label-sm text-label-sm border border-secondary dark:border-blue-400 rounded px-2 py-0.5 hover:bg-secondary dark:hover:bg-blue-900 hover:text-white transition-all">عرض الخدمات</button>
                </div>
              </div>
        ...
        <div className="max-w-container-max mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-lg max-w-5xl mx-auto">
            ...
            <div className="bg-surface-white dark:bg-surface border-2 border-secondary dark:border-blue-600 rounded-xl p-lg flex flex-col items-center relative overflow-hidden scale-105 shadow-md">
              ...
              <h3 className="font-headline-sm text-headline-sm text-secondary dark:text-blue-400 mb-xs">باقة متوسطة</h3>
              <div className="text-display-lg font-display-lg text-text-primary dark:text-on-surface mb-md">$49 <span className="text-body-sm font-body-sm text-text-muted dark:text-on-surface-variant">/شهرياً</span></div>
              <ul className="text-right w-full space-y-sm mb-lg">
                <li className="flex items-center gap-xs font-body-md text-body-md dark:text-on-surface"><span className="material-symbols-outlined text-verification-blue dark:text-blue-400">check</span> 15 إعلان سيارة</li>
                <li className="flex items-center gap-xs font-body-md text-body-md dark:text-on-surface"><span className="material-symbols-outlined text-verification-blue dark:text-blue-400">check</span> ملف ورشة موثق</li>
                <li className="flex items-center gap-xs font-body-md text-body-md dark:text-on-surface"><span className="material-symbols-outlined text-verification-blue dark:text-blue-400">check</span> 3 إعلانات مميزة</li>
              </ul>
              <button className="mt-auto w-full bg-secondary dark:bg-blue-600 text-on-secondary dark:text-white py-xs rounded-lg font-label-lg text-label-lg hover:brightness-110 dark:hover:brightness-125 transition-all">اختر الباقة</button>
            </div>
            <div className="bg-surface-white dark:bg-surface border-2 border-accent-yellow dark:border-yellow-500 rounded-xl p-lg flex flex-col items-center hover:shadow-lg dark:hover:shadow-lg dark:shadow-yellow-500/20 transition-all">
              <div className="bg-accent-yellow dark:bg-yellow-500 text-text-primary dark:text-black px-3 py-1 rounded-full font-label-sm text-label-sm mb-sm">الأكثر طلباً</div>
              <h3 className="font-headline-sm text-headline-sm text-primary dark:text-yellow-400 mb-xs font-bold">باقة مميزة</h3>
              <div className="text-display-lg font-display-lg text-text-primary dark:text-on-surface mb-md">$99 <span className="text-body-sm font-body-sm text-text-muted dark:text-on-surface-variant">/شهرياً</span></div>
              <ul className="text-right w-full space-y-sm mb-lg">
                <li className="flex items-center gap-xs font-body-md text-body-md font-bold dark:text-on-surface"><span className="material-symbols-outlined text-verification-blue dark:text-blue-400">check</span> إعلانات غير محدودة</li>
                <li className="flex items-center gap-xs font-body-md text-body-md dark:text-on-surface"><span className="material-symbols-outlined text-verification-blue dark:text-blue-400">check</span> إدارة كاملة للمخزون</li>
                <li className="flex items-center gap-xs font-body-md text-body-md dark:text-on-surface"><span className="material-symbols-outlined text-verification-blue dark:text-blue-400">check</span> ترويج VIP دائم</li>
              </ul>
              <button className="mt-auto w-full bg-accent-yellow dark:bg-yellow-500 text-text-primary dark:text-black py-xs rounded-lg font-label-lg text-label-lg hover:brightness-95 dark:hover:brightness-110 transition-all">تواصل للمزيد</button>
            </div>
          </div>
        </div>
      </section>
