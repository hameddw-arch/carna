...
export default function BrowseCarsPage() {
  ...
  return (
    <>
      ...
      <section className="py-xl px-margin-desktop bg-surface-white dark:bg-slate-900 border-b border-border-light dark:border-slate-800">
        <div className="max-w-container-max mx-auto">
          <h2 className="font-headline-md text-headline-md text-text-primary dark:text-slate-100 mb-lg text-right">تصفح حسب نوع الهيكل</h2>
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-md">
            {/* Sedan */}
            <div className="bg-surface-white dark:bg-slate-800 border border-border-light dark:border-slate-700 rounded-xl p-md flex flex-col items-center justify-center gap-sm cursor-pointer hover:border-accent-yellow dark:hover:border-yellow-400 transition-all group">
              ...
              <span className="font-label-lg text-label-lg text-text-primary dark:text-slate-200">سيدان</span>
            </div>
            {/* SUV */}
            <div className="bg-surface-white dark:bg-slate-800 border border-border-light dark:border-slate-700 rounded-xl p-md flex flex-col items-center justify-center gap-sm cursor-pointer hover:border-accent-yellow dark:hover:border-yellow-400 transition-all group">
              ...
              <span className="font-label-lg text-label-lg text-text-primary dark:text-slate-200">دفع رباعى (SUV)</span>
            </div>
            {/* Pickup */}
            <div className="bg-surface-white dark:bg-slate-800 border border-border-light dark:border-slate-700 rounded-xl p-md flex flex-col items-center justify-center gap-sm cursor-pointer hover:border-accent-yellow dark:hover:border-yellow-400 transition-all group">
              ...
              <span className="font-label-lg text-label-lg text-text-primary dark:text-slate-200">بيكاب</span>
            </div>
            {/* Van */}
            <div className="bg-surface-white dark:bg-slate-800 border border-border-light dark:border-slate-700 rounded-xl p-md flex flex-col items-center justify-center gap-sm cursor-pointer hover:border-accent-yellow dark:hover:border-yellow-400 transition-all group">
              ...
              <span className="font-label-lg text-label-lg text-text-primary dark:text-slate-200">فان</span>
            </div>
            {/* Hatchback */}
            <div className="bg-surface-white dark:bg-slate-800 border border-border-light dark:border-slate-700 rounded-xl p-md flex flex-col items-center justify-center gap-sm cursor-pointer hover:border-accent-yellow dark:hover:border-yellow-400 transition-all group">
              ...
              <span className="font-label-lg text-label-lg text-text-primary dark:text-slate-200">هاتشباك</span>
            </div>
            {/* Coupe */}
            <div className="bg-surface-white dark:bg-slate-800 border border-border-light dark:border-slate-700 rounded-xl p-md flex flex-col items-center justify-center gap-sm cursor-pointer hover:border-accent-yellow dark:hover:border-yellow-400 transition-all group">
              ...
              <span className="font-label-lg text-label-lg text-text-primary dark:text-slate-200">كوبيه</span>
            </div>
          </div>
        </div>
      </section>

      <section className="py-xl px-margin-desktop bg-surface-container-low dark:bg-slate-900">
        <div className="max-w-container-max mx-auto">
          <div className="flex justify-between items-center mb-lg">
            <h2 className="font-headline-md text-headline-md text-text-primary dark:text-slate-100">جميع السيارات المعروضة</h2>
            <div className="flex items-center gap-xs font-label-lg text-label-lg text-text-muted dark:text-slate-400">
          ...
          <div className="flex flex-col md:flex-row-reverse gap-lg">
            <aside className="w-full md:w-1/4 flex flex-col gap-sm">
              <div className="bg-surface-white dark:bg-slate-800 border border-border-light dark:border-slate-700 rounded-xl p-md">
                <h3 className="font-headline-sm text-headline-sm text-text-primary dark:text-slate-100 mb-md">الفلاتر</h3>
                <div className="space-y-md">
                  <div className="flex flex-col gap-xs">
                    <label className="font-label-sm text-label-sm text-text-muted dark:text-slate-400">حالة السيارة</label>
                    <div className="flex gap-xs">
                      <button onClick={() => handleFilterChange('condition', '')} className={`flex-1 py-2 border rounded-lg font-label-lg transition-colors ${!filters.condition ? 'border-primary dark:border-yellow-400 bg-primary-container dark:bg-yellow-500/20 text-primary dark:text-yellow-400' : 'border-border-light dark:border-slate-600 text-text-muted dark:text-slate-400 hover:border-primary dark:hover:border-yellow-400'}`}>الكل</button>
                      <button onClick={() => handleFilterChange('condition', 'جديد')} className={`flex-1 py-2 border rounded-lg font-label-lg transition-colors ${filters.condition === 'جديد' ? 'border-primary dark:border-yellow-400 bg-primary-container dark:bg-yellow-500/20 text-primary dark:text-yellow-400' : 'border-border-light dark:border-slate-600 text-text-muted dark:text-slate-400 hover:border-primary dark:hover:border-yellow-400'}`}>جديد</button>
                      <button onClick={() => handleFilterChange('condition', 'مستعمل')} className={`flex-1 py-2 border rounded-lg font-label-lg transition-colors ${filters.condition === 'مستعمل' ? 'border-primary dark:border-yellow-400 bg-primary-container dark:bg-yellow-500/20 text-primary dark:text-yellow-400' : 'border-border-light dark:border-slate-600 text-text-muted dark:text-slate-400 hover:border-primary dark:hover:border-yellow-400'}`}>مستعمل</button>
                    </div>
                  </div>
                  <div className="flex flex-col gap-xs text-right">
                    <label className="font-label-sm text-label-sm text-text-muted dark:text-slate-400">المحافظة</label>
                    <select value={filters.city} onChange={(e) => handleFilterChange('city', e.target.value)} className="border border-border-light dark:border-slate-600 dark:bg-slate-700 dark:text-slate-100 rounded-lg font-body-md text-body-md w-full focus:ring-accent-yellow">
                      <option>كل المحافظات</option>
                      {dbGovernorates.map(gov => <option key={gov} value={gov}>{gov}</option>)}
                    </select>
                  </div>
                  <div className="flex flex-col gap-xs text-right">
                    <label className="font-label-sm text-label-sm text-text-muted dark:text-slate-400">الفئة</label>
                    <select value={filters.body_type} onChange={(e) => handleFilterChange('body_type', e.target.value)} className="border border-border-light dark:border-slate-600 dark:bg-slate-700 dark:text-slate-100 rounded-lg font-body-md text-body-md w-full focus:ring-accent-yellow">
                  ...
                  <div className="flex flex-col gap-xs text-right">
                    <label className="font-label-sm text-label-sm text-text-muted dark:text-slate-400">سنة الصنع</label>
                    <select value={filters.year} onChange={(e) => handleFilterChange('year', e.target.value)} className="border border-border-light dark:border-slate-600 dark:bg-slate-700 dark:text-slate-100 rounded-lg font-body-md text-body-md w-full focus:ring-accent-yellow">
                      <option>الكل</option>
                      <option>2024</option>
                      <option>2023</option>
                      <option>2022</option>
                  ...
                  <div className="flex flex-col gap-xs text-right">
                    <label className="font-label-sm text-label-sm text-text-muted dark:text-slate-400">السعر</label>
                    <div className="flex gap-xs">
                      <input value={filters.min_price} onChange={(e) => handleFilterChange('min_price', e.target.value)} className="w-1/2 border border-border-light dark:border-slate-600 dark:bg-slate-700 dark:text-slate-100 rounded-lg font-body-md text-body-md focus:ring-accent-yellow" placeholder="من" type="number" />
                      <input value={filters.max_price} onChange={(e) => handleFilterChange('max_price', e.target.value)} className="w-1/2 border border-border-light dark:border-slate-600 dark:bg-slate-700 dark:text-slate-100 rounded-lg font-body-md text-body-md focus:ring-accent-yellow" placeholder="إلى" type="number" />
                    </div>
                  </div>
                  {availableTags.length > 0 && (
                    <div className="flex flex-col gap-xs text-right">
                      <label className="font-label-sm text-label-sm text-text-muted dark:text-slate-400">الوسوم الشهيرة</label>
                      <div className="flex flex-wrap gap-xs">
                        <button
                          onClick={() => handleFilterChange('tag', '')}
                          className={`px-md py-xs border rounded-full font-label-sm transition-colors flex items-center gap-1 ${
                            !filters.tag ? 'border-primary dark:border-yellow-400 bg-primary-container dark:bg-yellow-500/20 text-primary dark:text-yellow-400' : 'border-border-light dark:border-slate-600 text-text-muted dark:text-slate-400 hover:border-primary dark:hover:border-yellow-400'
                          }`}
                        >
                          <span>الكل</span>
                        ...
                        {tagStats.slice(0, 6).map(({tag, count}) => (
                          <button
                            ...
                            className={`px-md py-xs border rounded-full font-label-sm transition-colors flex items-center gap-1 ${
                              filters.tag === tag ? 'border-primary dark:border-yellow-400 bg-primary-container dark:bg-yellow-500/20 text-primary dark:text-yellow-400' : 'border-border-light dark:border-slate-600 text-text-muted dark:text-slate-400 hover:border-primary dark:hover:border-yellow-400'
                            }`}
                          >
