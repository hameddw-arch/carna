...
const TIERS = [
  ...
  { id: 'basic',   label: 'أساسي',   price: 'تواصل معنا', color: '#2196F3', desc: 'شعار + قائمة خدمات + أولوية في البحث' },
  { id: 'premium', label: 'مميز', price: 'تواصل معنا', color: '#FFC107', desc: 'كل مميزات الأساسي + شارة ذهبية + ظهور دائم أعلى' },
]
